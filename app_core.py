...
def get_weights():
    ...
    if not user_weights:
        ...
        records = [{'id': record[0], 'date': record[1], 'weight': record[2], 'weight_percentile': record[3]} for record in user_weights]
...
def get_heights():
    ...
    if not user_heights:
        ...
        records = [{'id': record[0], 'date': record[1], 'height': record[2], 'height_percentile': record[3]} for record in user_heights]
